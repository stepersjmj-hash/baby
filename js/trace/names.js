...
/* 자모 상자 배치 (블록 안 비율) */
const CV_L = [0.04, 0.14, 0.48, 0.86];   // 자음 — 세로 모음 왼쪽
const CV_R = [0.56, 0.03, 0.95, 0.97];   // ㅏㅓㅣ류
const CH_T = [0.17, 0.06, 0.83, 0.47];   // 자음 — 가로 모음 위
const CH_B = [0.03, 0.50, 0.97, 0.94];   // ㅗㅜㅡ류
const FV_C = [0.05, 0.05, 0.46, 0.52];   // 받침 있는 글자의 자음(세로 모음)
const FV_V = [0.52, 0.02, 0.94, 0.58];
const FH_C = [0.19, 0.02, 0.81, 0.33];   // 받침 있는 글자의 자음(가로 모음)
const FH_V = [0.04, 0.33, 0.96, 0.60];
...
const SYL = {
  ...
  '최': [['ch', [0.05, 0.05, 0.50, 0.46]], ['o', [0.02, 0.42, 0.60, 0.80]], ['i', [0.66, 0.03, 0.94, 0.97]]],
  '해': [['h', [0.03, 0.12, 0.42, 0.88]], ['a', [0.46, 0.03, 0.70, 0.97]], ['i', [0.76, 0.03, 0.96, 0.97]]],
  '은': [['ng', [0.26, 0.03, 0.74, 0.42]], ['eu', [0.04, 0.40, 0.96, 0.62]], ['n', FIN]],
  '영': [['ng', FV_C], ['yeo', FV_V], ['ng', FIN]],
  '손': [['s', FH_C], ['o', FH_V], ['n', FIN]],
  '지': [['j', CV_L], ['i', CV_R]],
  '성': [['s', FV_C], ['eo', FV_V], ['ng', FIN]],
  '나': [['n', CV_L], ['a', CV_R]],
  '희': [['h', [0.06, 0.05, 0.52, 0.50]], ['eu', [0.02, 0.55, 0.60, 0.76]], ['i', [0.66, 0.03, 0.94, 0.97]]],
  '루': [['r', CH_T], ['u', CH_B]],
  '춘': [['ch', FH_C], ['u', FH_V], ['n', FIN]],
  '문': [['m', FH_C], ['u', FH_V], ['n', FIN]],
  '송': [['s', FH_C], ['o', FH_V], ['ng', FIN]],
  '자': [['j', CV_L], ['a', CV_R]],
  '원': [['ng', [0.07, 0.02, 0.40, 0.38]], ['u', [0.02, 0.33, 0.56, 0.62]],
         ['eo', [0.60, 0.02, 0.95, 0.60]], ['n', FIN]],
